# Ask the expert project (Capital Data)
...
def read_from_file():
    with open('python-coder2\meeting12\m12_capital_data.txt') as file:
        for line in file:
            line = line.rstrip('\n')
...
def write_to_file(country_name, city_name):
    with open('python-coder2\meeting12\m12_capital_data.txt', 'a') as file:
